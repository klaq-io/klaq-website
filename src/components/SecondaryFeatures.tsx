  ...
  return (
    ...
    >
      <div
        className={clsx(
          'w-9 rounded-lg',
          isActive ? 'bg-klaq-600' : 'bg-slate-500',
        )}
      >
      ...
      <h3
        className={clsx(
          ...
          isActive ? 'text-klaq-600' : 'text-slate-600',
        )}
      >
        {feature.name}
      </h3>
      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            Simplifier les tâches administratives de votre entreprise.
          </h2>
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            Structurer et gérer l'ensemble de votre activité.
          </p>
        </div>
        <FeaturesMobile />
        <FeaturesDesktop />
